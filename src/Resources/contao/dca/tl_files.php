...
$GLOBALS['TL_DCA']['tl_files']['palettes']['default'] = 'protected,syncExclude;preview,name,importantPartX,importantPartY,importantPartWidth,importantPartHeight; meta; {glide_settings};glide_number,glide_name;{glide_new_settings},glide_new,glide_featured,glide_example_img';
